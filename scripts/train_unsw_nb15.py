...
from data.unsw_nb15_loader import UNSWNB15Loader
...
logger = logging.getLogger("train_unsw_nb15")

def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--csv", required=True, help="Path to UNSW-NB15 CSV file")
    ...
    logger.info("=" * 65)
    logger.info("  Training on UNSW-NB15 Dataset")
    logger.info("=" * 65)

    # 1. Load Data
    logger.info(f"Loading data from {args.csv}")
    loader = UNSWNB15Loader(config_path)
