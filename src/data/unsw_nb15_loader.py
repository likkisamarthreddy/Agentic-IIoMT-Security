...
Handles specific UNSW-NB15 label parsing and feature encoding.
"""
...
class UNSWNB15Loader(DataPreprocessor):
    """
    DataPreprocessor tailored for the UNSW-NB15 dataset.
    ...
    def prepare_pipeline(
        ...
        label_col: str = "attack_cat",  # Default for UNSW-NB15
    ) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, Dict[str, int]]:
        """
        Execute the full preprocessing pipeline with UNSW-NB15 specific handling.
        """
        logger.info("Starting UNSW-NB15 prepare_pipeline")
        ...
        # 1.5 Handle Categorical Features & Drop Identifiers
        drop_cols = ['id']
